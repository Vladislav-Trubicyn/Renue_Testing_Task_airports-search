package ru.parser.utils.compressor;
...
/**
 * Класс, реализующий эффективный способ хранения строк с помощью сжатия и распаковки сжатых строк.
 * В основе сжатия и распаковки лежит стандартная библиотека{@link java.util.zip GZIP}.
 */
