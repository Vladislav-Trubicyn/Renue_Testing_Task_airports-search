package ru.parser.utils.autocomplete.container;

import java.util.ArrayDeque;
import java.util.Queue;

/**
 * Класс, реализующий <b>Тернарное дерево поиска (Ternary Search Tree)</b> с возможностью хранения дополнительных данных.
 * Исходный алгоритм был позаимствован с <a href="https://algs4.cs.princeton.edu/52trie/">сайта</a>.
 *
